...
class APPSBaseDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset, max_tokens, tokenizer_path, verbose=False):
        self.dataset = dataset
        self.max_tokens = max_tokens
        self.tokenizer = AutoTokenizer.from_pretrained(
            tokenizer_path, use_auth_token=False
        )
...
def get_apps_dataset(dataset, args, verbose: bool = False):
